...
def load_world():
    ...
    with HideOutput():
        #add_data_path()
        FETCH_URDF = os.path.join(igibson.assets_path, "models/fetch/fetch_gripper.urdf")

        robot = load_model(FETCH_URDF, fixed_base=True) # DRAKE_IIWA_URDF | KUKA_IIWA_URDF
...
def main():
    ...
    parser.add_argument('-g','--gui', action='store_true', help='Allow GUI rendering')
